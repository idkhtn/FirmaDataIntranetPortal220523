...
namespace Firma.Intranet.Controllers
{
    public class AktualnoscController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAktualnosci,LinkTytul,Tytul,Tekst,Pozycja")] Aktualnosc aktualnosc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAktualnosci,LinkTytul,Tytul,Tekst,Pozycja")] Aktualnosc aktualnosc)
        {
